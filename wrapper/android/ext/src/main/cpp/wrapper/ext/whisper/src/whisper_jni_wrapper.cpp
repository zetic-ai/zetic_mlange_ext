...
Java_com_zeticai_mlange_feature_automaticspeechrecognition_whisper_WhisperWrapper_nativeInit(
    JNIEnv *env, jobject thiz, jstring vocabulary_path) {
  whisper_processor = new WhisperProcessor();
  whisper_tokenizer =
      new WhisperTokenizer(convertJStringToCString(env, vocabulary_path));
}

extern "C" JNIEXPORT void JNICALL
Java_com_zeticai_mlange_feature_automaticspeechrecognition_whisper_WhisperWrapper_nativeDeinit(
...
Java_com_zeticai_mlange_feature_whisper_WhisperWrapper_nativeProcess(
...
Java_com_zeticai_mlange_feature_automaticspeechrecognition_whisper_WhisperWrapper_nativeDecodeToken(
    JNIEnv *env, jobject thiz, jintArray ids, jboolean skip_special_token) {
