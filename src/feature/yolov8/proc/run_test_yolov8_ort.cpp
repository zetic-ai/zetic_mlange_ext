...
// TO BE FILLED
Zetic_MLange_Feature_Result_t run_yolo_ort_model(std::string model_file_path,
...
void test_yolo8_ort(std::string model_file_path, std::string coco_file_path, std::string img_file_path, std::string result_img_file_path, YOLO_MODEL_TYPE yolo_model_type) {
    ...
    run_yolo_ort_model(model_file_path, 
...
int main(int argc, char **argv) {
    ...
    test_yolo8_ort(model_file_path, input_coco_file_paths_arg, input_file_paths_arg, output_file_paths_arg, YOLO_DETECT_V8);
